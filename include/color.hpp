...
namespace dye
{
    ...
    template<typename T>
    Colored<T> colorize(T t, int c)
    {
        return Colored<T>(t, c);
    }

    template<typename T>
    Colored<T> colorize(T t, int a, int b)
    {
        return Colored<T>(t, a, b);
    }

    template<typename T>
    Colored<T> colorize(T t, string a)
    {
        return Colored<T>(t, a);
    }

    template<typename T>
    Colored<T> colorize(T t, string a, string b)
    {
        return Colored<T>(t, a, b);
    }
